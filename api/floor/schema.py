...
class Floor(SQLAlchemyObjectType):
    """
        Autogenerated return type of CreateFloor
    """
    class Meta:
        model = FloorModel
...
class CreateFloor(graphene.Mutation):
    """
        Returns the payload upon creation of a floor
    """
    class Arguments:
...
class UpdateFloor(graphene.Mutation):
    """
        Returns floor payload on updating a floor
    """
...
class DeleteFloor(graphene.Mutation):
    """
        Returns the payload on floor deletion
    """
...
class Query(graphene.ObjectType):
    """
        Query to return the floors data
    """
    all_floors = graphene.Field(
        ...
        description="Returns a list of paginated floors. Accepts the arguments\
            \n- page: Page number of floors\
            \n- per_page: The number of floors per page\
            \n- name: Name field of a floor"
    )
    get_rooms_in_a_floor = graphene.List(
        lambda: Room,
        floor_id=graphene.Int(),
        description="Returns rooms in a floor. Accepts the argument\
            \n- floor_id: Unique identifier of a floor"
    )
    filter_by_block = graphene.List(
        Floor,
        blockId=graphene.Int(),
        description="Returns a list of floors in a specific block. Accepts the argument\
    ...
    def resolve_get_rooms_in_a_floor(self, info, floor_id):
        # Returns all room in a specific floor
...
class Mutation(graphene.ObjectType):
    create_floor = CreateFloor.Field(
        description="Creates a new floor in a block given the arguments\
            \n- state: Check if the floor is created\
            \n- name: The name field of the floor\
            \n- block_id: The unique identifier of the block where the \
            specified floor is")
    update_floor = UpdateFloor.Field(
        description="Updates a floor with the arguments below\
            \n- name: The name field of the floor\
            \n- floor_id: The unique identifier of a floor")
    delete_floor = DeleteFloor.Field(
        description="Deletes a floor given the arguments\
            \n- state: Check if the floor is active, archived or deleted\
            \n- floor_id: Unique identifier of a floor")
