...
class QueryRooms(BaseTestCase):
    ...
    def test_query_room_with_nonexistant_id(self):
        query = self.client.execute(room_query_by_nonexistant_id)
        self.assertEquals(query, room_query_by_nonexistant_id_response)
