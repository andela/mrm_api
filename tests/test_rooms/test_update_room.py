...
class TestUpdateRoom(BaseTestCase):
    ...
    def test_if_all_fields_updated(self):
        ...
        self.assertEquals(test_update_all_fields , expected_query_update_all_fields)
    ...
    def test_update_for_only_required_fields(self):
        ...
        self.assertEquals(test_edit_only_required_field, expected_query_update_only_required_field) 
    ...
    def test_for_error_if_id_not_supplied(self):
        ...
        self.assertEquals(test_get_error_if_no_id, expected_query_without_room_id) 
