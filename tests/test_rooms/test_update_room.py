...
class TestUpdateRoom(BaseTestCase):
    ...
    # test if you get error once  'id' is not supplied in update query
    def test_for_error_if_id_not_supplied(self):
        test_get_error_if_no_id = self.client.execute(query_without_id)

        assert test_get_error_if_no_id == expected_query_without_id
