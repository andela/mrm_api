...
class TestEventsRoomQuery(BaseTestCase):
    ...
    def test_query_all_events_by_room_with_dates(self):
        """
        Test an admin or super admin can query for all events in a room with calendar Id,start date and end date
        """
    ...
    def test_query_all_events_by_room_without_dates(self):
        """
        Test an admin or super admin can query for all events in a room with the calendar Id only
        """
        CommonTestCases.admin_token_assert_equal(
            self,
            query_all_events_by_room_without_dates,
    ...
    def test_query_all_events_by_room_with_invalid_calendar_id(self):
        """
        Test an admin or super admin can query for all events with an invalid calendar Id
    ...
    def test_query_all_events_by_room_without_callendar_id(self):
        """
        Test an admin or super admin can query for all events without a calendar Id
        """
        CommonTestCases.admin_token_assert_in(
            self,
            query_all_events_by_room_without_callendar_id,
