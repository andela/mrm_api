...
class TestRoomResponse(BaseTestCase):
    ...
    def test_room_response_with_date_range(self):
        ...
        """
        CommonTestCases.admin_token_assert_equal(
            self, get_room_response_query_by_date,
            get_room_response_query_by_date_query)
    ...
    def test_room_response_with_invalid_date(self):
        ...
        """
        CommonTestCases.admin_token_assert_in(
            self, get_room_response_query_with_invalid_date,
    ...
    def test_room_with_invalid_date_difference(self):
        ...
        """
        CommonTestCases.admin_token_assert_in(
            self, get_room_response_query_with_higher_lower_limit,
    ...
    def test_database_connection_error(self):
        ...
        CommonTestCases.admin_token_assert_in(
            self, get_room_response_query, "The database cannot be reached")
        CommonTestCases.admin_token_assert_in(
            self, summary_room_response_query,
            "The database cannot be reached")
        CommonTestCases.admin_token_assert_in(
            self, filter_by_response_query, "The database cannot be reached")
        CommonTestCases.admin_token_assert_in(
            self, search_response_by_room_only,
            "The database cannot be reached")
