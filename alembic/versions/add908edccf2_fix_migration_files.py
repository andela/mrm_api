...
Revision ID: add908edccf2
Revises: 84a1aa841faa
Create Date: 2019-06-06 13:27:47.055914
...
def upgrade():
    ...
    op.drop_constraint('locations_structure_id_fkey',
    ...
    op.add_column('office_structures', sa.Column('state', sa.Enum(
        'active', 'archived', 'deleted', name='statetype'), nullable=True))
...
def downgrade():
    ...
    op.create_table('structure',
                    ...
                    sa.Column('tag_id', sa.INTEGER(),
                              autoincrement=False, nullable=True),
                    sa.Column('lft', sa.INTEGER(),
                              autoincrement=False, nullable=False),
                    sa.Column('rgt', sa.INTEGER(),
                              autoincrement=False, nullable=False),
                    ...
                    sa.ForeignKeyConstraint(['parent_id'], [
                        'structure.id'], name='structure_parent_id_fkey', ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
                        ['tag_id'], ['tags.id'], name='structure_tag_id_fkey', ondelete='CASCADE'),
    ...
    op.add_column('locations', sa.Column('structure_id',
                                         sa.INTEGER(), autoincrement=False, nullable=True))
    op.create_foreign_key('locations_structure_id_fkey', 'locations', 'structure', [
                          'structure_id'], ['id'], ondelete='CASCADE')
    # ### end Alembic commands ###
